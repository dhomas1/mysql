...
Check the [releases](https://github.com/droboports/mysql/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/mysql.git
cd mysql
./build.sh
ls -la *.tgz
```
